...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "jacobian_publisher_node");
    ros::NodeHandle nh;

    // Starting the asynchronous spinner to attend the calls
    ros::AsyncSpinner spinner(3);
    spinner.start();

    // Moveit Initialization Of the Cycle
    // .. _RobotModelLoader:
    ...
    // kinematic_state->setJointPositions(joint_model_group);
